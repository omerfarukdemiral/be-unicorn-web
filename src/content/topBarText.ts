...
export const TOP_BAR_TEXT: Record<string, string> = {
  ...
  // Unicorn yolu: the 7-step stepper in the stage section + the Yol haritası panel.
  'top.roadmapTitle': 'Unicorn yolu: {stage} ({n}/7). Yol haritasını aç.',
  'top.companyTitle': 'Şirketin: {v}',
  'roadmap.title': 'Unicorn yolu',
  'roadmap.here': 'Buradasın',
  'roadmap.next': 'Sıradaki',
  'roadmap.done': 'Geçildi',
  'roadmap.target': 'Hedef',
  'roadmap.round': 'Tur',
  'roadmap.roundValue': '{amount} · %{equity} hisse',
  'roadmap.noRound': 'Tur yok, sadece sen',
  'roadmap.gap': '{stage} için {v} değerleme eksik.',
  'roadmap.ready': '{stage} kapıda. Turu başlatma vakti.',
  'roadmap.won': 'Unicorn oldun. Kampüs senin.',
  'roadmap.step': '{n}/7',
}
